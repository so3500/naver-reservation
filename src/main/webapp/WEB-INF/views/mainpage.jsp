...
<body>
		...
		<div class="event">
			...
			<div class="section_event_tab">
				<ul class="event_tab_lst tab_lst_min">
					<li class="item" data-category-id="0"><a class="anchor active">
							<span>전체리스트</span>
					</a></li>
				</ul>
			</div>
			<div class="section_event_lst" data-start-product-no="0"
				data-category-id="0">
	...
	<script type="rv-template" id="promotion_template">
		<li class="item" style="background-image: url(/api/productImages/{{productId}}/{{productImageId}})">
