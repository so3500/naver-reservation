        ...
        <div class="ct" data-product-id=${product.id}>
            <div class="ct_wrap">
                    ...
                    <div class="store_details">
                        ...
                        <p class="dsc">
                        	<c:forEach var="productPrice" items="${productPrices}">
                        		${productPrice.priceTypeName}: <fmt:formatNumber value="${productPrice.price}" type="number"/> / <fmt:parseNumber value="${productPrice.discountRate}" integerOnly="true"/>% 할인
                        		<br>
                        	</c:forEach>
                        </p>
                    </div>
                    	...
                    	<c:forEach var="productPrice" items="${productPrices}">
	                    	<div class="qty" data-product-price-id=${productPrice.id} data-product-price=${productPrice.price}>
	                            ...
	                            <div class="qty_info_icon">
	                            	...
	                            	<strong class="product_price"> <span class="price"><fmt:formatNumber value="${productPrice.price}" type="number"/></span> <span class="price_type">원</span></strong>
	                            	<em class="product_dsc"><fmt:formatNumber value="${productPrice.price}" type="number"/> (<fmt:parseNumber value="${productPrice.discountRate}" integerOnly="true"/>% 할인가)</em>
								</div>
	                        </div>
                    	</c:forEach>
                    </div>
                            ...
                            <form id="rsv_form" class="form_horizontal">
                                ...
                                <div class="inline_form"> <label class="label" for="tel"> <span class="spr_book ico_nessasary">필수</span> <span>연락처</span> </label>
                                    <div class="inline_control wrap">
                                        ...
                                        <div class="warning_msg">000-0000-0000 형식을 지켜주세요.</div>
                                    </div>
                                </div>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable"> <button type="button" id="rsv_form_summit_btn" class="bk_btn"> <i class="spr_book ico_naver_s"></i>  <span>예약하기</span> </button> </div>
                </div>
            </div>
        </div>
    </div>
