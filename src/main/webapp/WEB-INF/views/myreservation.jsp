											...
											<div class="card_body">
												...
												<div class="middle">
													<div class="card_detail">
														<em class="booking_number">No.${reservInfo.id}</em>
														<h4 class="tit">${reservInfo.productDescription}</h4>
														<ul class="detail">
															<li class="item">
														...
														<div class="price_summary">
															...
															<em class="price_amount">
																<span><fmt:formatNumber value="${reservInfo.sumPrice}" type="number"/></span>
											...
											<div class="card_body">
												...
												<div class="middle">
													<div class="card_detail">
														...
														<div class="booking_cancel">
															<a href="/reviewWrite?displayInfoId=${reservInfo.displayInfoId}&reservInfoId=${reservInfo.id}"><button class="btn"><span>예매자 리뷰 남기기</span></button></a>
														</div>
													</div>
												</div>
												<div class="right"></div>
